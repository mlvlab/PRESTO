class MessageTemplate:
    ...
    [PROMPT] is where the prompt withlbe inserted.
    """
    ...
    def fill(self, prompt=''):
        ...
        if isinstance(self.template, list):
            return [{**msg, "content": msg["content"].replace("[PROMPT]", prompt)} if "[PROMPT]" in msg["content"] else msg for msg in self.template]
